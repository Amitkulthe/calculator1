...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button divition = findViewById(R.id.divition);
        ...
        divition.setOnClickListener(calculatorListener);
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int lenght = displayelements.length();
                if (lenght> 0) {
                    displayelements = displayelements.substring(0,lenght-1);
                    calculatorScreen.setText(displayelements);
                }
            }
        });

        final Button clearScreen = findViewById(R.id.clearscreen);
